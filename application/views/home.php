        ...
        <header class="masthead">
			<div class="container d-flex h-100 align-items-center">
				<div class="mx-auto text-center">
					<h1 class="mx-auto my-0 text-uppercase">Muhammad Ismael Arshad</h1>
					<h2 class="text-white-50 mx-auto mt-2 mb-5">A strong and flexible developer dedicated to clean and maintainable code</h2>
        ...
        <section class="projects-section bg-dark" id="projects">
            <div class="container">
                ...
                <div class="row justify-content-center no-gutters mb-5 mb-lg-0">
                    <div class="col-lg-6"><img class="img-fluid" src="application/views/assets/img/OrderManagementSystem.PNG" alt="" /></div>
                    <div class="col-lg-6">
